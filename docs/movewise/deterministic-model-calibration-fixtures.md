...
1. **Condition:** Worth a closer look / Promising if… / No clear advantage yet / High financial risk under these assumptions.
...
| F03 | Broad family improvement                    | Family of four. Cushion improves `$500 → $2,500`; housing burden remains below 35%; commute improves; suitable space and support network are confirmed.                                         | **Worth a closer look; substantially better fit.** Financial Security is the strongest lift.                                    | What evidence would be sufficient for the highest band?                                                |
...
| F05 | Partner employment determines viability     | Family of four. Destination cushion range is `-$600 → $1,600` depending on unconfirmed partner income; housing and commute improve.                                                             | **Promising if partner employment is confirmed; assumption-sensitive range crossing a financial blocker.**                      | Should calculation proceed with this range or wait for a confirmed employment branch?                  |
...
| F07 | One dollar below the burden boundary        | Same as F06 except housing is `$3,499` against `$7,000` gross.                                                                                                                                  | **No hard housing blocker; likely mixed.** The result may still warn about fragility.                                           | Does the discontinuity feel defensible, or should a caution zone precede the blocker?                  |
...
| F09 | Required services unverified                | Family with a child who needs continuing therapy or special-education services. Finances and commute improve; destination service continuity is unverified and marked essential.                | **Promising if continuity is verified; not favorable yet.** No generic city service score is invented.                          | Should MoveWise accept a user-confirmed availability fact, or require evidence before calculating?     |
...
| ID  | Scenario                                   | Material facts                                                                                                                  | Provisional expected behavior                                                  | Primary calibration question                                                             |
| --- | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------- |
| I01 | Confirmed career and financial improvement | Individual with confirmed job. Cushion improves `$900 → $2,400`; commute shortens; preferred climate improves.                  | **Worth a closer look; substantially better fit.**                             | Are strong confirmed gains sufficient for the highest band without household inputs?     |
